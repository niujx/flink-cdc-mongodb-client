...
public class OplogMongoDBSource {
    ...
    public static final String OUTPUT_FORMAT_SCHEMA =
            MongoSourceConfig.OutputFormat.SCHEMA.name().toLowerCase(Locale.ROOT);
    ...
    public static class Builder<T> {
        ...
        public DebeziumSourceFunction<T> build() {
            ...
            props.setProperty(
                    "connector.class", MongoDbConnector.class.getCanonicalName());
            ...
            props.setProperty("mongodb.name", UUID.randomUUID().toString());
            ...
            props.setProperty(
                    MongoSourceConfig.ERRORS_TOLERANCE_CONFIG, MongoSourceConfig.ErrorTolerance.NONE.value());

            //写死 不支持全量同步
            props.setProperty("snapshot.mode", "never");
            props.setProperty(MongoDbConnectorConfig.CAPTURE_MODE.name(),"oplog");
